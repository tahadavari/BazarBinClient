                ...
                <div className="flex items-center justify-between gap-3">
                    <div className="text-right">
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-muted-foreground sm:text-base">
                            پرامپت موردنظر خود را ثبت کنید تا پاسخ بر اساس داده‌های این دیتاست تولید شود. هنگام پردازش
                            پاسخ، امکان ویرایش فیلد پرامپت غیرفعال خواهد شد.
                        </p>
                    </div>
                        ...
                        {isDatasetLoading ? (
                            ...
                            <form className="space-y-6" onSubmit={handleSubmit}>
                                <div className="space-y-2">
                                    ...
                                    />
                                    <p className="text-xs text-muted-foreground">پاسخ بر اساس داده‌های همین دیتاست
                                        محاسبه می‌شود.</p>
                                </div>
