                ...
                <Table>
                  ...
                  <TableBody>
                    {columns.map((column, index) => {
                      ...
                      return (
                        <TableRow key={column.id} className={disabled ? "opacity-50" : undefined}>
                          ...
                          <TableCell>
                            <div className="flex items-center gap-2">
                              ...
                              />
                              <span className="text-xs text-muted-foreground">درون‌ریزی</span>
                            </div>
                          </TableCell>
                          <TableCell>
                            <div className="space-y-1">
                              ...
                              {columnNameError ? (
                                ...
                                <p className="text-xs text-muted-foreground">
                                  پیشنهاد: <span className="font-medium">{column.autoColumnName}</span>
                                </p>
                              )}
                            </div>
                          </TableCell>
